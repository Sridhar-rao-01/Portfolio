...
const bootLines = [
  ...
  {
    text: "[ OK ] Loading modules: react@19, next@16, three@0.184",
    delay: 200,
  },
      ...
      {!isComplete && (
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-2xl px-6">
            ...
            >
              <h1 className="text-5xl font-bold tracking-tight glow-text text-accent font-(family-name:--font-geist-mono)">
                {"<HACKBITS />"}
              </h1>
              <p className="mt-2 text-sm text-muted font-(family-name:--font-geist-mono)">
            ...
            <div className="terminal-window glow-box">
              ...
              <div className="p-5 min-h-70 font-(family-name:--font-geist-mono) text-sm">
              ...
              <div className="px-5 pb-4">
                <div className="h-1.5 w-full rounded-full bg-surface-light overflow-hidden">
                  <motion.div
                    className="h-full rounded-full bg-linear-to-r from-accent to-accent-alt"
                    initial={{ width: 0 }}
                    animate={{ width: `${progress}%` }}
                    transition={{ duration: 0.3, ease: "easeOut" }}
                  />
                </div>
                <p className="mt-2 text-xs text-right text-muted font-(family-name:--font-geist-mono)">
